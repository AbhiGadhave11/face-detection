...
export function CameraList() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      setCameras((prev) =>
        prev.filter((c) => c.id !== deleteDialog.camera!.id)
      );
  ...
  return (
    <Box>
      ...
      {cameras.length === 0 ? (
        ...
        <Box
          ...
          gridTemplateColumns={{
            ...
            md: "1fr 1fr 1fr", // 3 columns on desktops
          }}
      ...
      <Dialog open={deleteDialog.open} onClose={handleDeleteCancel}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to delete "{deleteDialog.camera?.name}"? This
            action cannot be undone and will also delete all associated alerts.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
